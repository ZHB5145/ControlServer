...
class KeyboardListener:
    ...
    def isCommandHolding(self):
        return ('command' in self.key_state_map and self.key_state_map['command']) \
               or ('left command' in self.key_state_map and self.key_state_map['left command'] == 'down') \
               or ('right command' in self.key_state_map and self.key_state_map['right command'] == 'down')
